...
namespace Main_Project
{
  ...
  /// <summary>
  /// The Proj class provides a CLS compliant, MWArray interface to the MATLAB functions
  ...
  public class Proj : IDisposable
  {
    ...
    /// <summary>
    /// Provides a void output, 0-input MWArrayinterface to the Main_Project MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    {
      mcr.EvaluateFunction(0, "Main_Project", new MWArray[]{});
    }


    /// <summary>
    /// Provides a void output, 1-input MWArrayinterface to the Main_Project MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    ///
    public void Main_Project(MWArray Image_Path)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input MWArray interface to the Main_Project MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// arguments.</returns>
    ///
    public MWArray[] Main_Project(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "Main_Project", new MWArray[]{});
    }


    /// <summary>
    /// Provides the standard 1-input MWArray interface to the Main_Project MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// arguments.</returns>
    ///
    public MWArray[] Main_Project(int numArgsOut, MWArray Image_Path)
    {
