...
Main_Project_overview.html - HTML overview documentation file for the generated 
                             component. It contains the requirements for accessing the 
                             component and for generating arguments using the MWArray 
                             class hierarchy.

Main_Project.xml - This file contains the code comments for the Main_Project component 
